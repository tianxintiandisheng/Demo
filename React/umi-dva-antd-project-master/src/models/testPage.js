...
export default {
  ...
  reducers: {
    ...
    addNum(state, _) {
      ...
      stateChange.num = num2;
      console.log(this);
      console.log(stateChange);
      const stateChange2 = { ...stateChange };
      console.log(stateChange2);
      console.log(typeof stateChange2);
      console.log(stateChange2 === stateChange);
      return { ...stateChange };
    },
    showShopping(state, { shoppingStore }) {
      // 接收action,并解构出来
      const stateChange = state;
      stateChange.shoppingStore = shoppingStore;
      return { ...stateChange };
    },
  },
